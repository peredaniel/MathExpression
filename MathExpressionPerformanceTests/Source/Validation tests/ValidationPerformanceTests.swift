...
class ValidationPerformanceTests: XCTestCase {
    var a: Int16!
    var b: Int16!
    var c: Int16!
    var d: Int16!
    ...
    func testPerformanceInvalidFormulaThrowsError_emptyExpression() {
        measure {
            _ = try? MathExpression("")
        }
    }

    func testPerformanceInvalidFormulaThrowsError_unevenBracketNumber() {
        let formula = String(format: Formula.ValidationTests.Invalid.unevenBracketNumber, a, b, c, d, e)

        measure {
            _ = try? MathExpression(formula)
        }
    }

    func testPerformanceInvalidFormulaThrowsError_misplacedBrackets() {
    ...
    func testPerformanceInvalidFormulaThrowsError_misplacedSumAndClosingBracket() {
    ...
    func testPerformanceInvalidFormulaThrowsError_misplacedSubtractionAndClosingBracket() {
    ...
    func testPerformanceInvalidFormulaThrowsError_misplacedProductAndClosingBracket() {
    ...
    func testPerformanceInvalidFormulaThrowsError_misplacedDivisionAndClosingBracket() {
    ...
    func testPerformanceInvalidFormulaThrowsError_misplacedOpeningBracketAndProduct() {
    ...
    func testPerformanceInvalidFormulaThrowsError_misplacedOpeningBracketAndDivision() {
    ...
    func testPerformanceInvalidFormulaThrowsError_productFollowedByDivision() {
    ...
    func testPerformanceInvalidFormulaThrowsError_divisionFollowedByProduct() {
    ...
    func testPerformanceInvalidFormulaThrowsError_consecutiveProducts() {
    ...
    func testPerformanceInvalidFormulaThrowsError_consecutiveDivisions() {
    ...
    func testPerformanceInvalidFormulaThrowsError_sumFollowedByProduct() {
    ...
    func testPerformanceInvalidFormulaThrowsError_sumFollowedByDivision() {
    ...
    func testPerformanceInvalidFormulaThrowsError_subtractionFollowedByProduct() {
    ...
    func testPerformanceInvalidFormulaThrowsError_subtractionFollowedByDivision() {
    ...
    func testPerformanceInvalidFormulaThrowsError_startsWithProduct() {
    ...
    func testPerformanceInvalidFormulaThrowsError_startsWithDivision() {
    ...
    func testPerformanceInvalidFormulaThrowsError_endsWithSum() {
    ...
    func testPerformanceInvalidFormulaThrowsError_endsWithSubtraction() {
    ...
    func testPerformanceInvalidFormulaThrowsError_endsWithProduct() {
    ...
    func testPerformanceInvalidFormulaThrowsError_endsWithDivision() {
    ...
    func testPerformanceValidFormulaNotThrowingError_generic() {
    ...
    func testPerformanceValidFormulaNotThrowingError_consecutiveSubtractions() {
    ...
    func testPerformanceValidFormulaNotThrowingError_consecutiveSums() {
    ...
    func testPerformanceValidFormulaNotThrowingError_consecutiveSumAndSubtraction() {
    ...
    func testPerformanceValidFormulaNotThrowingError_consecutiveSubtractionAndSum() {
